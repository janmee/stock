 ...
 * @version 1.0
 */
public class DateBetweenPageProcessor implements PageProcessor {
...
//        Date date = stockDailyService.selectLastestDay(symbol);
        Date date = null;
        try {
            date = DateUtils.parseDate("2015-01-01", DateUtils.PATTREN_DATE);
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new DateBetweenPageProcessor()).addUrl(request).thread(6).run();
    }
